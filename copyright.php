        ...
        <div class="container"style="position: sticky; top: 60px;">
          <form method="post" action="send.php" class="form-horizontal" role="form" id="LaedsForm" >
            ...
            <div class="input-group">
              ...
              <span id="phone_error"class="text-dange"><?php echo $contactnoErr; ?></span>
            </div>

            <div class="input-group">
              <!-- <label>Email Id</label> -->
              <input type="email" name="email" placeholder="Enter Email" id="contact_email" onkeyup="validatEmail()" >
              <span id="email_error"class="text-dange"><?php echo $emailErr; ?></span>
            </div>   
            <br>
            <div class="input-group" style="max-width:88% ;">
                 ...
                 <!-- <div class="col-lg-12"> -->
                   ...
                   <span class="text-dange"><?php echo $typeOfSerrvicesErr; ?></span>
                 <!-- </div> -->
               </div>
               <!-- <br> -->
            ...
            <div class="input-group">
              <!-- <label>City</label> -->
              <input type="text" name="city" placeholder="Enter City name"  id="contact_city" onkeyup="validatCity()" >
              <span id="city_error"class="text-dange"><?php echo $cityErr; ?></span>
            </div>   
            ...
            <div class="input-group">
              ...
              <!-- <div class="col-sm-12"> -->
               ...
               <br> -->
                    <!-- <div   class="col-sm-12" > -->
                      <input id="button" type="submit" name="save" class="" value="Submit"onclick="return validatForm()">
                    <!-- </div> -->

             </div>

          <!-- <button>Submit</button> -->
          <span id="submit_error" id="contact_submit" onkeyup="validatSubmit()"></span>
